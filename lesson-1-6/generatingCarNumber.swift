...
public func generatingCarNumber() -> String {
    ...
    let generation = (seriesSymbol1: alphabeticalArray.randomElement()!,
                      registrationNumber: Int.random(in: 100..<999),
                      seriesSymbol2: alphabeticalArray.randomElement()!,
                      seriesSymbol3: alphabeticalArray.randomElement()!,
                      region: arrayRegions.randomElement()!)
